-- Hotfix wydajności: usunięcie korelowanego NOT EXISTS z last_visited CTE.
-- Wszystkie istniejące rekordy mają is_confirmed=false (DEFAULT z migr. 011),
-- więc NOT EXISTS skanował całą tabelę station_stops dla każdego wiersza.
-- Wracamy do prostej heurystyki czasowej (+2h offset strefy).
