-- Rozdziela carrier_name na dwie osobne kolumny:
--   train_name   = sc.train_name (nazwa własna pociągu, np. "Hańcza")
--   carrier_name = c.name        (pełna nazwa przewoźnika, czyszczona w frontendzie)
