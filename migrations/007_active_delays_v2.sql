-- Przebudowa v_active_delays: jeden wiersz na pociąg zamiast jednego na przystanek.
...
LEFT JOIN commercial_categories cc ON sc.commercial_category = cc.symbol
